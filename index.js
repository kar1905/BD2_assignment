...
function sortAscendingPricing(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortDescendingPricing(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    result.sort(sortAscendingPricing);
  } else if (pricing === 'high-to-low') {
    result.sort(sortDescendingPricing);
  }
...
function sortDescendingRating(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    result.sort(sortAscendingRating);
  } else if (rating === 'high-to-low') {
    result.sort(sortDescendingRating);
  }
  res.json({ hotels: result });
});
...
function sortAscendingReviews(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}
function sortDescendingReviews(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    result.sort(sortAscendingReviews);
  } else if (reviews === 'most-to-least') {
    result.sort(sortDescendingReviews);
  }
  res.json({ hotels: result });
});
